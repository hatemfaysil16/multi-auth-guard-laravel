<?php
use App\Http\Controllers\Auth\Admin\AuthenticatedSessionController as AuthenticatedSessionControllerAdmin;
...
Route::middleware('guest')->group(function () {
    ...
    Route::get('login', [AuthenticatedSessionController::class, 'create'])->name('login.user');
...
Route::prefix('admin')->middleware('guest')->group(function () {
    Route::get('login', [AuthenticatedSessionControllerAdmin::class, 'create'])->name('login.admin');
    Route::post('login', [AuthenticatedSessionControllerAdmin::class, 'store']);
});

Route::prefix('admin')->middleware('auth:admin')->group(function () {
    Route::post('logout', [AuthenticatedSessionControllerAdmin::class, 'destroy'])->name('logout.admin');
});
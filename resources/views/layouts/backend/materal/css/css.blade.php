        ...
        @if(App()->getLocale() ==='ar')
		<link href="{{ asset('backend/assets/css/demo1/style.bundle.rtl.css') }}" rel="stylesheet" type="text/css" />
        @endif
		<link href="{{ asset('backend/assets/css/demo1/skins/header/base/light.css') }}" rel="stylesheet" type="text/css" />
        @if(App()->getLocale() ==='ar')
            <link href="{{ asset('backend/assets/css/demo1/skins/header/base/light.rtl.css') }}" rel="stylesheet" type="text/css" />
        @endif
        ...
        @if(App()->getLocale() ==='ar')
            <link href="{{ asset('backend/assets/css/demo1/skins/brand/dark.rtl.css') }}" rel="stylesheet" type="text/css" />
        @endif
        <link href="{{ asset('backend/assets/css/demo1/skins/aside/dark.css') }}" rel="stylesheet" type="text/css" />

        @if(App()->getLocale() =='ar')
            <link href="{{ asset('backend/assets/css/demo1/skins/aside/dark.rtl.css') }}" rel="stylesheet" type="text/css" />
        @endif
        ...
        @stack('style')
		<!--end::Layout Skins -->
		<link rel="shortcut icon" href="{{ asset('frontend/assets/img/favicon/android-chrome-192x192.png') }}" type="image/x-icon">  


<style>
		.vertifcal td,.vertifcal th {

...
<div id="kt_header" class="kt-header kt-grid__item  kt-header--fixed ">
    ...
    <div style="visibility: hidden" class="kt-header-menu-wrapper" id="kt_header_menu_wrapper">
        <div id="kt_header_menu" class="kt-header-menu kt-header-menu-mobile  kt-header-menu--layout-default ">
            <ul class="kt-menu__nav ">
                <li class="kt-menu__item  kt-menu__item--open kt-menu__item--here kt-menu__item--submenu kt-menu__item--rel kt-menu__item--open kt-menu__item--here kt-menu__item--active" data-ktmenu-submenu-toggle="click" aria-haspopup="true"><a href="javascript:;" class="kt-menu__link kt-menu__toggle"><span class="kt-menu__link-text">{{ TanslationHelper::translate('Pages') }}</span><i class="kt-menu__ver-arrow la la-angle-right"></i></a>
                    <div class="kt-menu__submenu kt-menu__submenu--classic kt-menu__submenu--left">
                        <ul class="kt-menu__subnav">
                            <li class="kt-menu__item  kt-menu__item--active " aria-haspopup="true"><a href="demo1/index.html" class="kt-menu__link "><span class="kt-menu__link-icon"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
                                        ...
                                        </svg></span><span class="kt-menu__link-text">{{ TanslationHelper::translate('My Account') }}</span></a></li>
                ...
                <li class="kt-menu__item  kt-menu__item--submenu kt-menu__item--rel" data-ktmenu-submenu-toggle="click" aria-haspopup="true"><a href="javascript:;" class="kt-menu__link kt-menu__toggle"><span class="kt-menu__link-text">@lang('lang.Features')</span><i class="kt-menu__ver-arrow la la-angle-right"></i></a>
                ...
                <li class="kt-menu__item  kt-menu__item--submenu kt-menu__item--rel" data-ktmenu-submenu-toggle="click" aria-haspopup="true"><a href="javascript:;" class="kt-menu__link kt-menu__toggle"><span class="kt-menu__link-text">@lang('lang.Apps')</span><i class="kt-menu__ver-arrow la la-angle-right"></i></a>
                    <div class="kt-menu__submenu kt-menu__submenu--classic kt-menu__submenu--left">
                        <ul class="kt-menu__subnav">
                            <li class="kt-menu__item " aria-haspopup="true"><a href="javascript:;" class="kt-menu__link "><span class="kt-menu__link-icon"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
                                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
    ...
    <div class="kt-header__topbar">
        <!--begin: Language bar -->
        @include('layouts.backend.head.Language')
        <!--end: Language bar -->

        <!--begin: User Bar -->
        @include('layouts.backend.head.top_model')
        <!--end: User Bar -->
    </div>
    ...
    <div class="kt-subheader   kt-grid__item" id="kt_subheader">
        <div class="kt-container  kt-container--fluid " style="">
            <div class="kt-subheader__main">
                <h3 class="kt-subheader__title"> @yield('page_left') </h3>
                <span class="kt-subheader__separator kt-hidden"></span>
                <div class="kt-subheader__breadcrumbs">
                    <a href="{{route('Admin_dashboard')}}" class="kt-subheader__breadcrumbs-home"><i class="flaticon2-shelter"></i></a>
                    <span class="kt-subheader__breadcrumbs-separator"></span>
                    <a href="@yield('page_center_link')" class="kt-subheader__breadcrumbs-link">
                        @yield('page_center') </a>
                    <span class="kt-subheader__breadcrumbs-separator"></span>
                    <a href="@yield('page_right_link')" class="kt-subheader__breadcrumbs-link">
                        @yield('page_right') </a>
            ...
            <div class="kt-subheader__toolbar">
                <div class="kt-subheader__wrapper">
                    <a href="{{route('Admin_dashboard')}}" class="btn kt-subheader__btn-primary">
                         {{ TanslationHelper::translate('Actions') }}&nbsp;
                    </a>
                </div>
            </div>
        </div>

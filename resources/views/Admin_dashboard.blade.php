...
@section('page_title',TanslationHelper::translate('dashboard'))
@section('style')
...
<div class="kt-content  kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor" id="kt_content">
    ...
    <!-- begin:: Content Head -->
    <div style="visibility: hidden" class="kt-subheader  kt-grid__item" id="kt_subheader">
        <div class="kt-container  kt-container--fluid ">
            <div class="kt-subheader__main">
                <h3 class="kt-subheader__title">{{TanslationHelper::translate('Dashboard')}}</h3>
                <span class="kt-subheader__separator kt-subheader__separator--v"></span>
                <span class="kt-subheader__desc">#XRS-45670</span>
                <a href="#" class="btn btn-label-warning btn-bold btn-sm btn-icon-h kt-margin-l-10">
                    {{TanslationHelper::translate('Add New')}}
                </a>
            ...
            <div class="kt-subheader__toolbar">
                <div class="kt-subheader__wrapper">
                    <a href="#" class="btn kt-subheader__btn-secondary">{{TanslationHelper::translate('Today')}}</a>
                    <a href="#" class="btn kt-subheader__btn-secondary">{{TanslationHelper::translate('Month')}}</a>
                    <a href="#" class="btn kt-subheader__btn-secondary">{{TanslationHelper::translate('Year')}}</a>

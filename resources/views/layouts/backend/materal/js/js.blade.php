        ...
        <script src="{{ asset('backend/assets/toastr/js/toastr.js') }}" type="text/javascript"></script>
        <script src="{{ url('backend/assets/ckeditor/ckeditor.js') }}" type="text/javascript"></script>
        @urls
        @yield('js')
        @stack('js')
		@include('layouts.MassageValidations.MassageValidation')
